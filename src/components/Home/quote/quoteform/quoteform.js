        ...
        return(
                    ...
                    <form className="form home__quote--form-cont">
                        ...
                        <div className="home__quote--form-control">
                            ...
                            <label className="home__quote--form-label">Name</label>
                            <FormControl 
                        ...
                        <div className="home__quote--form-control">
                            ...
                            <label className="home__quote--form-label">Email</label>
                            <FormControl 
                        ...
                        {/* <div className="home__quote--form-control">
                            ...
                            <input type="submit" value="Send" onClick={(e)=>this.submitForm(e)} className="home__quote--form-submit" />
