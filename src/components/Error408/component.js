                 ...
                 <section className="notfound__content">
                     ...
                     <div className="notfound__ow">
                         ...
                         <span className="notfound__ow--o">
                             ...
                             <small className="notfound__ow--o-text">Timedout</small>
                         </span>
                         <span className="notfound__ow--f-2">8</span>

                     </div>
                     <div className="notfound__message">

                        <h3 className="notfound__message--title">The request Timedout</h3>

                        <p className="notfound__message--text">
                            You got to this page because your request has timedout,however,there's always a 
                            second try so you can just try again
                            

                        </p>

                        <Link to="/" className="link">
                            <button className="notfound__message--btn">Try again</button>
                        </Link>
                     </div>
                 </section>
