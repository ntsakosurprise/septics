export default[
        ...
        {
            styles: {
                me: {className:" font-fd-xx-tn  mg-right-fd-xxx-md d-inline-block list__item list__item--marg-offset-bottom-small"},
                child:{className: "link__fg-secondary",add: true}
               },
        path: "/postjob",
        name: "+ Post a job",
        // icon: "pe-7s-graph",
