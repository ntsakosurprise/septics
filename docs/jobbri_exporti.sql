...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 29, 2020 at 01:50 PM
...
INSERT INTO `jo_company` (`id`, `name`, `company_slug`, `company_size`, `website`, `phone`, `company_bio`) VALUES
(1, 'jumaltrading', 'jumalTrading', '5', 'www.jumaltrading.co.za', '011 748 6542', 'We are a digital agency'),
(2, 'ironman', 'ironMan', '55', 'www.iornman.co.za', '012 748 6542', 'We are a digital agency'),
(3, 'turtrozz', 'turtrozz', '15', 'www.turtrozz.co.za', '061 748 6542', 'We are a digital agency'),
(4, 'fledja', 'fledja', '5', 'www.fledja.com', '011 848 6542', 'We are a digital agency'),
(5, 'avuxenicomputeracademy', 'avuxeinComputerAcademy', '155', 'www.avuxeniacademy.academy', '011 788 6542', 'We are a digital agency'),
(6, 'microsof', 'microsoft', '715', 'www.microsoft.com', '011 748 6542', 'We are a digital agency');
...
CREATE TABLE `jo_job_alerts_subscription` (
  `id` int(11) NOT NULL,
  `u_id` int(11) DEFAULT NULL,
  `job_id` int(11) DEFAULT NULL,
...
(1, 'applicant', 'Surprise', 'Mashele', 'mashelesurprise@gmail.com', '072-286-8851', '/img/user.jpeg', '2020-02-28 10:53:25'),
...
--
-- Indexes for table `jo_job_alerts_subscription`
--
ALTER TABLE `jo_job_alerts_subscription`
  ADD PRIMARY KEY (`id`),
  ADD KEY `u_id` (`u_id`),
  ADD KEY `job_id` (`job_id`);
...
--
-- AUTO_INCREMENT for table `jo_job_alerts_subscription`
--
ALTER TABLE `jo_job_alerts_subscription`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `jo_job_alerts_subscription`
  ADD CONSTRAINT `jo_job_alerts_subscription_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `jo_user` (`id`),
  ADD CONSTRAINT `jo_job_alerts_subscription_ibfk_2` FOREIGN KEY (`job_id`) REFERENCES `jo_job` (`id`);
...
ALTER TABLE `jo_search_history`
  ...
  ADD CONSTRAINT `jo_search_history_ibfk_2` FOREIGN KEY (`job_id`) REFERENCES `jo_job` (`id`);
