...
CREATE TABLE IF NOT EXISTS jo_category(
...
CREATE TABLE IF NOT EXISTS jo_company(
...
CREATE TABLE IF NOT EXISTS jo_recruiter(

  id INT AUTO_INCREMENT PRIMARY KEY,
  r_type ENUM('admin','executive','regular'),
  u_id INT,
  company_id INT,

  FOREIGN KEY(u_id) REFERENCES jo_user(id),
  FOREIGN KEY(company_id) REFERENCES jo_company(id)

) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci; 


CREATE TABLE IF NOT EXISTS jo_job(
  ...
  FOREIGN KEY(u_id) REFERENCES jo_user(id),
  FOREIGN KEY (job_category_id) REFERENCES jo_category(id),
  FOREIGN KEY (company_id) REFERENCES jo_company(id),
  FOREIGN KEY (country_id) REFERENCES jo_country(id),
  FOREIGN KEY (state_id) REFERENCES jo_states(id)
...
CREATE TABLE  jo_flag_jobs(
   ...
   FOREIGN KEY(job_id) REFERENCES jo_job(id)
...
CREATE TABLE  jo_blog_post( 
 ...
 updated_at  TIMESTAMP DEFAULT NOW(),
  ...
  FOREIGN KEY(u_id) REFERENCES  jo_blog_user(id) ON DELETE NO ACTION ON UPDATE NO ACTION 
...
/* Jobbri TABLE DATA DUMBPINGS */


-- Data dump for table Jo_user ---

INSERT INTO jo_user(id,u_type,first_name,last_name,email,phone,profile_url,join_date) VALUES


   (NULL,'applicant','Surprise','Mashele','mashelesurprise@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Ntsako','Sithole','ntsakosithole@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Kanye','West','kanyewest@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Curtis','Jackson','curtisjackson@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Maya','Wegerif','mayawegerif@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Kulanihappy','Mashele','kulanihappymash@gmail.com','072-286-8851','/img/user.jpeg',NOW()),
   (NULL,'recruiter','Revlon','Hobyani','revlonhobyani@gmail.com','072-286-8851','/img/user.jpeg',NOW());
...
-- Data dump for table Jo_address ---
...
-- Data dump for table Jo_account ---
...
-- Data dump for table Jo_user_account_login ---
...
-- Data dump for table Jo_login ---

INSERT INTO jo_login VALUES


   (NULL,'1','12054s5f05sf','mashelesurprise@gmail.com'),
   (NULL,'2','12054s5f05sf','ntsakosithole@gmail.com'),
   (NULL,'3','12054s5f05sf','kanyewest@gmail.com'),
   (NULL,'4','12054s5f05sf','curtisjackson@gmail.com'),
   (NULL,'5','12054s5f05sf','mayawegerif@gmail.com'),
   (NULL,'6','12054s5f05sf','mayawegerif@gmail.com'),
   (NULL,'7','12054s5f05sf','revlonhobyani@gmail.com');

INSERT INTO jo_company VALUES


   (NULL,'jumaltrading','jumalTrading','5','www.jumaltrading.co.za','011 748 6542','We are a digital agency'),
   (NULL,'ironman','ironMan','55','www.iornman.co.za','012 748 6542','We are a digital agency'),
   (NULL,'turtrozz','turtrozz','15','www.turtrozz.co.za','061 748 6542','We are a digital agency'),
   (NULL,'fledja','fledja','5','www.fledja.com','011 848 6542','We are a digital agency'),
   (NULL,'avuxenicomputeracademy','avuxeinComputerAcademy','155','www.avuxeniacademy.academy','011 788 6542','We are a digital agency'),
   (NULL,'microsof','microsoft','715','www.microsoft.com','011 748 6542','We are a digital agency');

INSERT INTO jo_recruiter VALUES
...
-- Data dump for table Jo_blog_user ---
